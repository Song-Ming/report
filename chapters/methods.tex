...
\begin{flushleft}
For this project, 3 Convolutional Neural Network (CNN) models were used: ConvNeXt, EfficientNetV2 
and MobileNetV3. These models were chosen due to their excellent performance on ImageNet and 
