...
characteristics from the X-rays in the MURA dataset which reduces the impact of the pretraining step.

(discuss ensemble results  compared to Alzubaidi et al. and Tahir et al.)
