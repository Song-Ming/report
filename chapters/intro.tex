...
This project aims to develop a framework to train attention based CNN models to detect elbow fractures from X-rays. We also aim to finetune 2 pretrained medical 
vision language foundation models on the same dataset to compare against the CNN models and evaluate their performance.
\end{flushleft}
