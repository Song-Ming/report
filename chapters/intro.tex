...
This project aims to use data processing techniques, pretraining and the addition of attention mechanisms to maximise the performance of 3 CNN models in detecting 
elbow fractures. These models as well as an ensemble model will then be compared against 2 vision language foundation models trained on the same dataset to evaluate
